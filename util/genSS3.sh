...
echo "In genSS3.sh, INPUTMTXis: "$INPUTMTX
...
echo Pass1 ....
$PSIPREDDIR/bin/psipred $INPUTMTX $PSIPREDDIR/data/weights.dat $PSIPREDDIR/data/weights.dat2 $PSIPREDDIR/data/weights.dat3 > $rootname.ss
